...
exports.getOne = (req, res) => {
    ...
    Sponsor.findOne({
        ...
        if (error) throw error;
        if(!sponsor) res.status(SponsorMessages.error.e1.http).send(SponsorMessages.error.e1);
...
exports.update = (req, res) => {
    ...
    Sponsor.findOneAndUpdate({
        ...
        if (error) throw error;
        if(!sponsor) res.status(SponsorMessages.error.e0.http).send(SponsorMessages.error.e0);
